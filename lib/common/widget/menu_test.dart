...
class _GZXDropDownMenuTestPageState extends State<GZXDropDownMenuTestPage> {
  List<String> _dropDownHeaderItemStrings = ['本月','筛选'];
...
//              SizedBox(height: 20,),
              ...
              GZXDropDownHeader(
                ...
                items: [
                  ...
                  GZXDropDownHeaderItem("",iconData: Icons.search),
                  //GZXDropDownHeaderItem(_dropDownHeaderItemStrings[3], iconData: Icons.search, iconSize: 18),
                ],
